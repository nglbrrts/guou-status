...
const MonthSelector: React.FC = () => {
  ...
  return (
    <div className="h-12 px-1 flex items-center justify-between bg-neutral-100 w-fit dark:bg-neutral-800 rounded-full border border-gray-200 dark:border-neutral-700 min-w-[200px]">
